...
digraph TCA {
  layout=circo
  root=node5
  node1 [root=true, label=Citrate]
  node2 [label="cis-Aconitase"]
  node3 [label="Isocitrate"]
  node4 [label="&#945;-Ketoglutarate"]
  node5 [label="Succinyl-CoA"]
  node6 [label="Succinate"]
  node7 [label="Fumarate"]
  node8 [label="L-Malate"]
  node9 [label="Oxaloacetate"]
  
  node1 -> node2 [label="Aconitase"];
  node2 -> node3 [label="Aconitase"];
  node3-> node4 [label="Isocitrate dehydrogenase"];
  node4 -> node5 [label="&#945;-Ketoglutarate dehydrogenase"];
  node5 -> node6 [label="Succinyl-CoA synthetase"];
  node6 -> node7 [label="Succinate dehydrogenase"];
  node7 -> node8 [label="Fumerase"];
  node8 -> node9 [label="Malate dehydrogenase"];
  node9 -> node1 [label="Citrate synthase"];
}
```
---
...
Function in [biochemistry]{.rn rn-type=circle rn-color=blue rn-animate=true} often revolves around a reversible protein-ligand interaction.
\begin{align}
...
::: {.fragment .fade-in}
::: {style="margin-top:1em; background-color: lightblue; padding:0.5em"}
...
::: {.fragment .fade-in}
::: {style="font-size: 0.8em;"}
Other enzymes are regulated by reversible __covalent modification__.
:::
:::

::: {.fragment .fade-in}
::: {style="font-size: 0.8em;"}
Both classes of regulatory enzymes tend to be multisubunit proteins, and in some cases the regulatory site(s) and the active site are on separate subunits.
:::
:::
...
::: {.fragment .fade-in}
::: {style="font-size: 0.8em;"}
Others are activated when peptide segments are removed by proteolytic cleavage.
:::
:::

::: {.notes}
Examples of enzymes activated by proteolytic cleavage?
...
Examples of allosteric enzymes? Aspartate transcarbomylase
